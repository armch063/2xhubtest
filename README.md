...
do  local ui =  game:GetService("CoreGui"):FindFirstChild("2XUi")  if ui then ui:Destroy() end end
...
local win = ui:W1n("                                                                                                                    RightControl      ","                               2XHUB   |  FreeScript            ",0.30,Enum.KeyCode.RightControl)
local Main1 = win:Tap("Main + Settings")
local Main3 = Main1:newpage()
local Settings = Main1:newpage()
local Auto = win:Tap("Auto+Stats")
local Main = Auto:newpage()
local Stats = Auto:newpage()
local H = win:Tap("TP+SHOP")
local Teleport = H:newpage()
local Shop = H:newpage()
local D = win:Tap("Dungeon+DevilFruit")
local Dungeon = D:newpage()
local DevilFruit = D:newpage()
local m = win:Tap("Misc")
local Misc = m:newpage()
-- A1
