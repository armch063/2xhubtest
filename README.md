...
local Library = Update:Window("2XHUB","",Enum.KeyCode.RightControl);
local Main3 = Library:Tab("Main2")
...
local SelectWeapon = Main3:Dropdown("Select Weapon",Wapon,function(Value)
